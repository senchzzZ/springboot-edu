            ...
            if (r.code == 200){
                ...
                for (var i = 0;i < universities.length;i++){
                    ...
                    e += '<div class="product-list-item mb-40">\n' +
                        ...
                        '                    <a target="_blank" href="/page/university/get/' + data.id + '">\n' +
                        ...
                        '                <h4><a target="_blank" href="/page/university/get/' + data.id + '">' + data.name + '</a></h4>\n' +
                        ...
                        '                        <ul>\n' +
                        '                            <li><a class="pro-add-btn" target="_blank" href="/page/university/get/' + data.id + '"><i class="ion-eye"></i>院校详情</a></li>\n' +
                        '                            <li><a class="pro-add-btn" target="_blank" href="/page/university/get/' + data.id + '"><i class="ion-clipboard"></i>招生简章</a></li>\n' +
