package com.ultron.admin.oa.controller;
...
import com.ultron.admin.oa.service.NotifyRecordService;
...
public class NotifyController extends BaseController {
	...
	String selefNotify() {
		return "admin/oa/notify/selfNotify";
	}
